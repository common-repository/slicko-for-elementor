 ...
 * @since 1.0.0
 */
class Slicko_Featured_Image extends Widget_Base {
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return __( 'Featured Image', 'slicko' );
    }
    /**
     * Get widget icon.
     *
    ...
    public function get_icon() {
        return 'slicko eicon-featured-image';
    }
    /**
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options'   => [
                    ''        => __( 'Default', 'slicko' ),
                    'fill'    => __( 'Fill', 'slicko' ),
                    'cover'   => __( 'Cover', 'slicko' ),
                    'contain' => __( 'Contain', 'slicko' ),
                ],
                'default'   => '',
                'selectors' => [
...
$widgets_manager->register_widget_type( new \Slicko_Addons\Widgets\Slicko_Featured_Image() );